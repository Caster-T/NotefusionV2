...
const Perfil = () => {
  ...
  const [userDescription, setUserDescription] = useState("Descripcion del usuario");

  const handleDescriptionChange = () => {
    const newDescription = prompt("Ingresa una nueva descripción:", userDescription); // Prompt para ingresar nueva descripción
...
<div className="grid-container2">
    ...
    <div className="profile-container">
      ...
      <div className="profile-info">
        ...
        <button onClick={handleDescriptionChange}>Modificar Descripción</button> 
      </div>
      <LogoutButton>
